...
Contributing to GIANT Core
============================

The GIANT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GIANT Core project, and is not to be
confused with overall GIANT Network Protocol consensus changes.

Whether a pull request is merged into GIANT Core rests with the project merge
...
Patches that change GIANT consensus rules are considerably more involved than
...
Where a patch set proposes to change the GIANT consensus, it must have been
...
The project leader is the release manager for each GIANT Core release.
