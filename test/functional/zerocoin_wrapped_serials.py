...
from fake_stake.base_test import GIANT_FakeStakeTest

class zGICwrappedSerialsTest(GIANT_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zGICs..." % DENOM_TO_USE)
