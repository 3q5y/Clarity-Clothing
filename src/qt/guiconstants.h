...
/* Giant GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GIANT"
#define QAPP_ORG_DOMAIN "giantpay.network"
#define QAPP_APP_NAME_DEFAULT "GIANT-Qt"
#define QAPP_APP_NAME_TESTNET "GIANT-Qt-testnet"
