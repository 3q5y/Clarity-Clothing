...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(GIC);
    unitlist.append(mGIC);
    unitlist.append(uGIC);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GIC:
            return QString("tGIC");
        case mGIC:
            return QString("mtGIC");
        case uGIC:
            return QString::fromUtf8("μtGIC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case GIC:
            return QString("GIC");
        case mGIC:
            return QString("Milli-GIC (1 / 1" THIN_SP_UTF8 "000)");
        case uGIC:
            return QString("Micro-GIC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case GIC:
            return QString("TestGICs");
        case mGIC:
            return QString("Milli-TestGIC (1 / 1" THIN_SP_UTF8 "000)");
        case uGIC:
            return QString("Micro-TestGIC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
