...
/** Utility functions used by the GIANT Qt UI.
 */
namespace GUIUtil
{
...
// Render GIANT addresses in monospace font
...
// Parse "giant:" URI into recipient object, return true on successful parsing
