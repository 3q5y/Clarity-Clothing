...
#ifndef GIANT_ZGICTRACKER_H
#define GIANT_ZGICTRACKER_H
...
public:
    CzGICTracker(std::string strWalletFile);
    ~CzGICTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzGICWallet* zGICWallet = NULL);
