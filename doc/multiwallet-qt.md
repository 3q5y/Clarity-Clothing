...
In order to support loading of multiple wallets in giant-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is giant.cpp.
...
Changes to giant.cpp
----------------------
giant.cpp is the entry point into giant-qt, and as such, will require some minor modifications to provide hooks for
