...
This mechanism has been integrated into Bitcore-Node-GIANT which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GiantPay/insight-api-giant#web-socket-api](https://github.com/GiantPay/insight-api-giant#web-socket-api) 
* API: [https://github.com/GiantPay/insight-api-giant#swifttx-transactions](https://github.com/GiantPay/insight-api-giant#swifttx-transactions) 
...
By default, the GIANT Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GIANT Core daemon:
