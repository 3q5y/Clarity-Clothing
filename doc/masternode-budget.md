...
GIANT now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<giant_address\> \<monthly_payment_giant\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ GIANT, _12_ times over the course of a year totaling _24000_ GIANT.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<giant_address\> \<monthly_payment_giant\> \<collateral_hash\>
 ...
 * vote-many          - Vote on a GIANT initiative
 * vote-alias         - Vote on a GIANT initiative
 * vote               - Vote on a GIANT initiative/budget
